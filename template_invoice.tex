...
\KOMAoptions{enlargefirstpage=true,fromalign=right,fromphone=true,fromemail=true,fromurl=true,fromlogo=true,backaddress=false,parskip=half*,firstfoot=false}
  ...
  \newcommand{\colspec}{@{}}
	...
	\begin{adjustwidth}{-4em}{} % Move table slightly left	
		\begin{tabular}{
			...
			\multicolumn{1}{p{13em}}{\flushleft Description} & % Description
			\multicolumn{1}{p{3em}}{\flushleft Qty} & % Amount
			\multicolumn{1}{p{3em}}{\flushleft Unit price} & % Unit price
			\multicolumn{1}{p{5em}}{\flushleft Subtotal} & % Amount without tax
			\multicolumn{1}{p{1.5em}}{\flushleft Sales\\Tax} & % Tax rate
			\multicolumn{1}{p{2em}}{\flushleft Tax\\amount} & % Tax amount
			\multicolumn{1}{p{5em}}{\flushleft Total}\\ \midrule % Total price with taxes
%+ for e in entries:
...
@{"%.2f" % float(e['qty'])} & % Amount
\$ @{e['price']} & % Unit price
\$ @{e['amount_net']} & % Amount without tax
...
%-
			\midrule
			&	Sub-total	& &	 & \$ @{amount_net}	&       &  \$ @{amount_taxes}     &	\$ @{amount_gross}\\ \cmidrule{8-8}
