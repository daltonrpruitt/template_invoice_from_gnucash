...
%			@{notes}}
        ...
        If paying by check, please make it out to Copper Key Software Connections or \usekomavar{fromname}.
...
@{str(e['taxtable']['percent_sum'])+'\%' if 'taxtable' in e else '-'} & % Tax rate
\$ @{e['amount_taxes']} & 
